...
searchDirectoryFiles(getcwd() . '/', 'package-oriel-tasks', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageOrielTasks', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Oriel Tasks', dashesToCamelCase($argv[1], true, ' '));
