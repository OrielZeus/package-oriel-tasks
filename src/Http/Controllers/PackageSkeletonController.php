<?php
namespace ProcessMaker\Package\PackageOrielTasks\Http\Controllers;

use ProcessMaker\Http\Controllers\Controller;
use ProcessMaker\Http\Resources\ApiCollection;
use ProcessMaker\Package\PackageOrielTasks\Models\Sample;
use RBAC;
use Illuminate\Http\Request;
use URL;


class PackageOrielTasksController extends Controller
{
    public function index(){
        return view('package-oriel-tasks::index');
    }
