<?php
namespace ProcessMaker\Package\PackageOrielTasks;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PackageOrielTasks\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PackageOrielTasks\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PackageOrielTasks\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'package-oriel-tasks');

        $this->publishes([
            __DIR__.'/../public' => public_path('vendor/processmaker/packages/package-oriel-tasks'),
        ], 'package-oriel-tasks');
